...
Auto completion triggers whenever the user enters a dot or types a \code{new} and will thus be discovered automatically. \intnote{stimmt das überhaupt?}
...
\intnote{todo Screnshot mit warning und ganzer codeblock... ers ist dumemrweise nicht so leciht dafny wrnings zu produzieren xD.}

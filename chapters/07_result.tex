...
\intnote{todo: ziele waren. symbol table. clean code/refactores, einfacher für andere entwickler unsere abreit weiter zu entwickeln (server), aber auch andere ide (isolation) , VS Code Marked Place, server rebasable, platformunabhängikeit, plugin easy isntallation (download server) }

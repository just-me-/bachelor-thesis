...
\intnote{Da fehlt Kapitel Features. Nein ist da. Ist nur nicht in unterkapitel aufgeteilt da ich das doof finde wenn ein subchapte 95prozent vom platz beansprucht. Es hat 1 Kapitel pro feature. ... 15 unterkapitel und es werden noch mehr; das sind zu viele ohne unterkapitel features mein ich, ned?}
...
\intnote{todo: ziele waren. einfacher für andere entwickler unsere abreit weiter zu entwickeln (server) - dazu gehören SonarQube und Log für Performance lecks , aber auch andere ide (isolation) , VS Code Marked Place, server rebasable, platformunabhängikeit, plugin easy isntallation (download server) }

...
This issue and possible solutions were described in chapter \ref{section:globalSymbolTable}.\\
...
Just like Rename, the feature won't work for code that includes the current file.

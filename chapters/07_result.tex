...
Our Dafny language server has reached a point where it can be merged back into the original Dafny project.
...
\cite{our-dafny-plugin}
dafny_lang_builds
dafny_lang_github
our-dafny-plugin
our-dafny-plugin-github-publish

--

Download of the Dafny language server
...
Um ein möglichst breites Publikum mit unserem Plugin anzusprechen, war uns von Anfang an corss plattrofm support sehr wichtig.
Wie im Kapitel xxx beschrieben, mussten wir unglücklicherweise von .NET Core auf .Net Framework umsteigen
wegen Dafny. Unser Language server hatte Schwierigkeiten damit, sich mit mono korrekt ausführen zu lassen. \\

Leider konnte das Problem nicht binnend vernünftiger Zeit gelöst werden, und wurde bis zum Ende leider nicht abgeschlossen.
Somit ist unser Language server - und somit auch das Plugin - zum aktuellen Stand leider nicht auf macOS oder Linux korrekt ausführbar. \\

Die Platformunabhängigkeit war ein essenzielles Ziel und bleibt leider ausstehend.
Daher kann unser Plugin als Konsequenz das bestehende Plugin nicht ablösen,
sondern wurde als separate, als Beta Version ausgezeichnete installation veröffentlicht.


chapter \ref{section:implementation:mono} \nameref{section:implementation:mono}

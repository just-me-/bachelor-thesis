...
JavaScript Object Notation (JSON) is is a language independent data format \cite{json}. \glsadd{json}\\
...
In the following text, the existing project will be referred as the \textit{pre-existing project}. \glsadd{pre_existing_project}

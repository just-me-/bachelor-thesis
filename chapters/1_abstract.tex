...
Aside features based on the symbol table, preexisting functionality was revisisted as well:
\begin{itemize}
    ...
    \item Unlike in prior versions of the plugin, warnings are now reported to the enduser as well.
    ...
    \item All features will now also work accross multiple files and namespaces.
\end{enumerate}
...
\begin{itemize}
    ...
    \item Auto completion \intnote{so incomplete lists findet corbat sicher heikel. weg damit? wenn wir aber schreiben ...bei common IDE features PUNKT. dann steht weider kommentar daneben 'welche?'}
\end{itemize}

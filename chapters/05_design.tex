...
{\bf StringResources} \textendash{} \intnote{resource mit einem s - das ist im code auch falsch und müsstest du noch korrigieren. Jepp. in den grafiken auch. kommt noch später}
...
This distribution has certain upward dependencies, which is not optimal. \intnote{Frage: warum zeichnest ud das ui package nicht einfach oberhalb, dann zeigt der pfeil nach unten? oder... This distribution has a seeming upwards dependency, but this is just because the graphic was drawn this way to save space doer sowas. Weile s eins hoch und eins runter gibt. das kann man ned anders zeichnen ohne dass eins hoch und eins runter geht. das wird bei der implementation behoben. und begründet. }
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{design/server7_resources.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{design/workflow1_regular.png}
    \caption{Overview}
    \label{fig:server_overview}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{design/workflow2_update.png}

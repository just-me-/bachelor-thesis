...
{\bf StringResources} \textendash{} \intnote{resource mit einem s - das ist im code auch falsch und müsstest du noch korrigieren.}
...
This distribution has certain upward dependencies, which is not optimal. \intnote{Frage: warum zeichnest ud das ui package nicht einfach oberhalb, dann zeigt der pfeil nach unten? oder... This distribution has a seeming upwards dependency, but this is just because the graphic was drawn this way to save space doer sowas.}

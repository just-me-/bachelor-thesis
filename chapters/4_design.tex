...
\intnote{ist nicht einiges schon implementation?}
...
\begin{lstlisting}[caption={Generic Method to Convert an IEnumerable}, captionpos=b, label={lst:genericconverter}]

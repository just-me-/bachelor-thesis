...
\intnote{<<<hier vielleicht nich beispiel screenshots oder codes rein? >>> 2do}

\intnote{ist nicht einiges schon implementation? evtl besser schreiben: "Wir haben entschieden, die komponeenten so und so aufzuteilen, wenn wir es dann implementeiren. statt: "wir haben es so und so implemntiert"}

...
Excluded from the figure are some converter methods, that convert \code{Diagnstoics}, such as warnings and errors, to a einheitlich format. Dafny and Boogie report their errors in different ways and different formats, which made their collecting actually relatively complex. To counterfeight that, simple converter extensions were written to unify any occuring errors.
...
\intnote{ps: waraum heisst eig alles manager xD?}

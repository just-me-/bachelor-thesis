...
The following figure \ref{fig:timetracking} shows the the invested time by activity.
...
Ref to kuchendiagramm todo \ref{fig:timetracking}
...
Thomas Kisstler was more involved in the realisation of the sybol table,

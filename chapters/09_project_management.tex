...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{milestones_planned}
...
\textit{Test}, \textit{Build} and \textit{Sonar}.
...
How good test coverage is can be seen in figure \ref{fig:test_coverage}.
We have not achieved 100\% coverage in all components.
This is due to the following reason:
It was very important for us to test the business logic of our language server.
For those classes with their own logic we have therefore set a test coverage of 100\%.
However, components that call Dafny itself and only pass information,
or interfaces to frameworks such as OmniSharp, have not been tested with our unit tests.
Dafny and OmniSharp contain own tests about their own logic. Therefore we assume that they work accordingly. We have put our focus on testing logic implemented by us.

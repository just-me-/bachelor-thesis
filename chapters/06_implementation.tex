...
\code{IDafnyRunner} to call compile and run as a callback as you can see for example in listing \ref{lst:compileAndRun}.
...
Unlike the Compile feature, the \code{CounterModelProvider} creates a callback and passes it to the \\

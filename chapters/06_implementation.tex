...
The whole code could be broken down into the individual components defined in the analysis phase.   \intnote{todo design?? analyse?}
...
\subsubsection{Customizable Through Configuration}
 \intnote{config - sollte neu dann auch noch durch gereiht werden oder über vscode_kapselung zur verfügung gestellt werden
...
\subsection{Server}
 ...
 \intnote{todo roadmap kapitel überblick einleitung}

\subsubsection{Server Launch}
 \intnote{todo "corbat-platsch"}
...
\subsection{Core}
 \intnote{Teils wird von BlaProvider gesprochen, teils kein Provider todo}
...
es ist auch nicht auszuschliessen, dass vs code in zukunft ein ähniches feature selbst noch implementieren wird.
 ...
 \intnote{tido irgend welche quellen raussuchen. vs code api oder so.}
...
durchreichen, client muss vscode api aufrufen

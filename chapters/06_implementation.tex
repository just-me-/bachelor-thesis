...
The \code{CodeLensProvider} component is very simple. CodeLens data transferred from the server is transferred to the VSCode API.
...
Regarding figure \ref{fig:fig:topDownPaintFTW}, imagine we hand the blue line as the cursor position.

...
Tt will run to completion and at worst just provide default values.
...
\intnote{todo bild hier unbedingt mit workspace -> filerepo -> physfile/translationresult/symobltablemanager und methoden die hier beschrieben werden.kann ja ovn der design ding kapitel vorlage nehmen}.
...
\intnote{wozu brauchen wir die eig?}

...
For simplicity,  \intnote{(constructors,)} private methods and variables are omitted in the diagrams.
...
The main package \code{dafnyLanguageServerStartup} is used by the \code{extension.ts}
...
\begin{figure}[H]
    ...
    \caption{Package \code{dafnyLanguageServerStartup}}
...
For each CodeLens element, for example a method, a \code{Command} object is also appended.

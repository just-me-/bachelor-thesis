...
Where is the definition of a symbol? What symbol is at the current cursor position?
...
the method \code{VSCodeCommandStrings.ShowReferences} from the VSCode API is called

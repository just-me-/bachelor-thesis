...
%%%%%%CI%&%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%
\intnote{ich würde ein eigenes CI-Kapitel aufschlagen... fragen nächste woche. weil das ci kapitel ist so bissl alles. von introduction (initial sit) bis hin zu analyse über lösung aka result/implementaiton\dots passt also iwie nirgends. länge rechtfertigt es auch locker ein eigenes kapitel zu sein.}

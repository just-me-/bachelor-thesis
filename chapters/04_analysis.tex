...
\begin{figure}[h]
    ...
    \caption{Communication Benefit of LSP, https://code.visualstudio.com/api/language-extensions/language-server-extension-guide} \intnote{muss man das bild iwie speziell reffen? - so abstract mässig?}

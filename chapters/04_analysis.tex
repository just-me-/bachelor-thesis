...
The representation of the CounterExample will also be improved.
...
Moreover, AutoCompletion is also able to provide general completion suggestions if one is not typing a word.

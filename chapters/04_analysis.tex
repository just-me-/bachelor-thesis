...
The current problem domain does not only require premade LSP messages like \code{completion} or \code{publishDiagnostics}, but also custom requests such as \code{CounterExample}, which is Dafny-specific.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=9.5cm]{analysis/namesegmentbsp.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=9.5cm]{analysis/methodbsp.png}

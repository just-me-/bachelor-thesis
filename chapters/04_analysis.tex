...
\intnote{Die andern hatten in ihrer arbeit noch:  Für jedes Features. Was tut es, warum implementieren, wer profitiert davon. sollen wir das auch machen? ja }
...
The parameter and response types can be custom classes and more flexibility. \intnote{allow for - is that correct english? naja. huge. maximum. great. das sind alle sso worte gwesen, die er bei der SA nicht toll fand. - more.}
...
\subsection{Visitor}
To generate a symbol table, it is common to use the visitor programming language pattern by Gamma et al \cite{gof}. \intnote{gof undefined heisst es. darf ich da keine ISBN angeben?}
...
\begin{figure}[H]
    \centering
    \includegraphics{analysis/verification}
...
\begin{figure}[H]
    \centering
    \includegraphics{analysis/compile}
...
\begin{figure}[H]
    \centering
    \includegraphics{analysis/counter_example}
...
\begin{figure}[H]
    \centering
    \includegraphics{analysis/analysis_completion_1}
...
\begin{figure}[H]
    \centering
    \includegraphics{analysis/analysis_completion_2}
...
\begin{figure}[H]
    \centering
    \includegraphics{analysis/analysis_goto_1}
...
\begin{figure}[H]
    \centering
    \includegraphics{analysis/analysis_goto_2}
...
\begin{figure}[H]
    \centering
    \includegraphics{analysis/analysis_codelens}
...
\begin{figure}[H]
    \centering
    \includegraphics{sonarexamaple.png}

...
\newglossaryentry{cd} % todo never used
{
	name=CD,
...
\newglossaryentry{codelens} %todo never used
{
	name=CodeLens,
	description={Preview of code usages. This word is a trademark by Microsoft}
}
%% codelens wird nirgend definiert. alles checken ob alles benutzt wird damits aufgenommen wird.... todo
%% ps sortierung muessen wir auch manuell machen

\newglossaryentry{vm} %% todo never used
{
	name=VM,
	description={Virtual Machine}
}

\newglossaryentry{msbuild}
{
	name=MSBuild,
